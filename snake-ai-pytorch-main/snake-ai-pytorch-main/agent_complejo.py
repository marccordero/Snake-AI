...
class Agente:
    ...
    def obtener_accion(self, estado):
        ...
        if random.randint(0, 200) < self.epsilon:
            ...
            prediccion = self.modelo_complejo(estado0)
        ...
        while  not hecho:
            ...
            if hecho:
                ...
                if puntuacion > record:
                    record = puntuacion
                    agente.modelo_complejo.guardar()
                ...
                plot(puntuaciones_grafico, puntuaciones_medias_grafico, 'complejo', save=False)
    plot(puntuaciones_grafico, puntuaciones_medias_grafico, 'complejo', save=True)
    save_results(puntuaciones_grafico, puntuaciones_medias_grafico, record, 'complejo')
