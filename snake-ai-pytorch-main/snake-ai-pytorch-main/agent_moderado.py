...
class Agente:
    ...
    def obtener_accion(self, estado):
        ...
        if random.randint(0, 200) < self.epsilon:
            ...
            prediccion = self.modelo_moderado(estado0)
        ...
        while  not hecho:
            ...
            if hecho:
                ...
                if puntuacion > record:
                    record = puntuacion
                    agente.modelo_moderado.guardar()
                ...
                plot(puntuaciones_grafico, puntuaciones_medias_grafico, 'moderado', save=False)
    plot(puntuaciones_grafico, puntuaciones_medias_grafico, 'moderado', save=True)
    save_results(puntuaciones_grafico, puntuaciones_medias_grafico, record, 'moderado')
